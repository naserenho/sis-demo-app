...
export const useAsync = <T, I, E = string>(
  ...
  return { execute, status, value, error, setStatus };
};
...
export class UseAsyncClass<T, E> extends PureComponent<
  UseAsyncClassProps<T, E>,
  UseAsyncClassState<T, E>
> {
